...
(() => {
  const ICONS = {
    ...
    // 翻訳(アドレスバーの翻訳アイコンと同じ形)
    translate: '<path d="M3 6h8M7 6c0 4-1.6 7-4 9M5.5 11c1 2.2 2.8 3.8 5 4.6"/><path d="M12.5 21l4-11 4 11M14 17.5h5"/>',
    // 見た目(ウィンドウの外観)
    palette:
      '<path d="M12 3a9 9 0 0 0 0 18h1.6a1.9 1.9 0 0 0 0-3.8h-.6a1.9 1.9 0 0 1 0-3.8H19A2 2 0 0 0 21 11.4 9 9 0 0 0 12 3z"/><circle cx="8.5" cy="9" r="1"/><circle cx="12" cy="7" r="1"/><circle cx="15.5" cy="9.5" r="1"/>',
    // タイマー・アラーム
    timer: '<circle cx="12" cy="13.5" r="7.5"/><path d="M12 10v3.5l2.5 1.8M9.5 2.5h5"/>',
  };
