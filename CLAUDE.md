...
- ユーザーに求められた改善は逐一ここに追記し、必ず次回以降に聞き継ぐ
  ...
  - (2026-07-17) サイドバー(パネル)の挙動はVivaldi準拠を維持する: レールの並び(ブックマーク/ダウンロード/履歴/メモ/リーディングリスト/Webパネル管理/ピン留め/+)、同じアイコン再クリックで折りたたみ、F4でパネル全体の表示切替、「+」でウェブパネル追加。新機能もVivaldiの流儀に合わせる
