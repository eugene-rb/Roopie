...
- ユーザーに求められた改善は逐一ここに追記し、必ず次回以降に聞き継ぐ
  ...
  - (2026-07-17) 依頼済み・未完了の機能(順に対応): ①パスワードマネージャーとオートフィル(住所・個人情報・クレカ)をChrome並みに拡充 ②スタート画面ウィジェット(天気/ノートパッド/カレンダー/ニュース。ショートカットと合わせてグリッドでスマホのホーム画面のように並べ替え) ③プロファイル切り替えをEdge挙動に(切り替え時に新しいウィンドウを開く)
