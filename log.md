...
最新: ショートカット追加時のタイトル自動取得、タブドラッグ/ドラッグ検索のアニメーション、settings CSP修正。※「拡張機能パズルボタン」はWIPコミット(9c3c8ce、メニューCSS未整備)
次の作業: パスワードマネージャーとオートフィル(住所・個人情報・クレカ)をChrome並みに拡充(ユーザー指示 2026-07-17)
